  ...
  return (
    <div className="bg-gradient-to-b from-customBlack to-customBlue min-h-screen py-4 px-4 antialised lg:flex justify-center items-center">
      <div className="flex flex-col justify-items-center">
        ...
        <hr className='border-darkGreen w-full mb-8' />
        <main>
          <h1 className="text-titleColor text-3xl font-inter text-center font-black mb-16">Componentes</h1>
          
          <div className="arduino">
            <h2 className="text-titleColor font-inter text-center text-lg font-bold mb-4 md:text-2xl">Arduino Uno</h2>
            <div className="flex flex-col md:flex-row md:items-center">
              <img src={Arduino} className="bg-titleColor p-3 rounded-lg mx-auto mb-6 md:p-6 md:mb-0 md:mr-6 w-full md:w-auto" alt="Imagem de um Arduino" />
              <div className="texto">
          ...
          <div className="bomba">
            ...
            <img src={Bomba} className='bg-titleColor p-3 rounded-lg mx-auto mb-6' alt="Imagem de um Arduino" />
            <div className="texto">
              ...
              <p className="text-white font-inter font-normal text-sm mb-16"> <span className='font-bold'>Preço:</span>Os preços podem variar de aproximadamente R$ 50 a R$ 200 ou mais</p>
            </div>
          </div>

          <div className="led">
            <h2 className="text-titleColor font-inter text-center text-lg font-bold mb-4">Iluminalçao LED</h2>
            <img src={Led} className='bg-titleColor p-3 rounded-lg mx-auto mb-6' alt="Imagem de uma lampada de led" />
            <div className="texto">
              ...
              <p className="text-white font-inter font-normal text-sm mb-16"> <span className='font-bold'>Preço:</span>  37,90 reais.</p>
            </div>
          </div>

          <div className="TDS">
            <h2 className="text-titleColor font-inter text-center text-lg font-bold mb-4">Sensor TDS Gravity Analog TDS sensor</h2>
            <img src={Tds} className='bg-titleColor p-3 rounded-lg mx-auto mb-6' alt="Imagem de um sensor TDS" />
            <div className="texto">
              <p className="text-white font-inter font-normal text-sm mb-4"> <span className='font-bold'>Função:</span>  Os sensores TDS são comumente usados em sistemas de purificação de água, aquários, controle de qualidade da água, agricultura hidropônica e outros campos onde a medição da qualidade da água é importante.</p>
              <p className="text-white font-inter font-normal text-sm mb-16"> <span className='font-bold'>Preço:</span> R$69,90 reais.</p>
            </div>
          </div>

          <div className="Bluetooh">
            <h2 className="text-titleColor font-inter text-center text-lg font-bold mb-4">Módulo Bluetooh</h2>
            <img src={Modulo} className='bg-titleColor p-3 rounded-lg mx-auto mb-6' alt="Imagem de um módulo Bluetooh" />
            <div className="texto">
              ...
              <p className="text-white font-inter font-normal text-sm mb-16"> <span className='font-bold'>Preço:</span> 13 a 40 reais.</p>
            </div>
          </div>
          ...
          <div className="Componentes">
            ...
            <img src={Fio} className='bg-titleColor p-3 rounded-lg mx-auto mb-6' alt="Imagem de alguns fios" />
            <div className="texto">
              <p className="text-white font-inter font-normal text-sm mb-4"> <span className='font-bold'>Função:</span>  Eles variam em tipo e tamanho, incluindo jumpers, cabos macho-macho e macho-fêmea, e são essenciais para trocar dados e sinais elétricos entre o Arduino e os dispositivos externos em um projeto eletrônico.</p>
              <p className="text-white font-inter font-normal text-sm mb-16"> <span className='font-bold'>Preço:</span> R$8 a R$15 reais.</p>
            </div>
          </div>
